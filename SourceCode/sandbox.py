...
from SourceCode.utils.audio_sampler import AudioSampler
...
class Sandbox:
    ...
    def generate_samples(self)  -> None:
        ...
        disassembling_strategy_selection = input("Please type in 1 for stochastic and 2 for equidistant dissasembling strategy.")
        ...
        #ToDo Prevent wrong input
        sampling_size = input("Please type in the sampling size:")
